...
Page({
  ...
  timeChoose(e) {
    if (e.detail.value) {
      this.setData({
        title2: (this.data.timeList)[e.detail.value]
      })
      this.init()
    }
  },
  ...
  init() {
    ...
    ctx.drawImage("../../images/zx3.png", 0, 0, this.data.canvasWidth, this.data.canvasHeight);
    ctx.font = "normal bold 16px Arial";
    ctx.fillStyle = "#fff"
    ctx.setTextAlign("left")
    ctx.fillText(this.data.title1, this.data.canvasWidth / 4, this.data.canvasWidth / 2.49)
    ctx.font = "normal normal 14px Arial";
    ctx.fillText(this.data.title2, this.data.canvasWidth / 2.3, this.data.canvasWidth / 1.453)
    ctx.font = "normal normal 12px Arial";
    ctx.fillText(this.data.money, this.data.canvasWidth / 1.595, this.data.canvasWidth / 1.02)
    ctx.fillText(this.data.name, this.data.canvasWidth / 1.595, this.data.canvasWidth / 0.962)
    ctx.fillText(this.data.project1, this.data.canvasWidth / 1.595, this.data.canvasWidth / 0.908)
    ...
    wx.getSetting({
      success: function (res) {
        ...
        if (res.authSetting['scope.writePhotosAlbum'] == false) {
          ...
          if (false) {
            const videoAd = wx.createRewardedVideoAd({
              adUnitId: 'adunit-ca2fdb3ce91059a3'
            })
            videoAd.onError(err => {
